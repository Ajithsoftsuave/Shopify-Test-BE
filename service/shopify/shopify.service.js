...
import { getCartDataByID, sendOrderInvoice } from "../../service/shopify/query/cart.js";
        ...
        if (param.paymentDetail.status === 'pending'){
          const invoiceParams = 
          {
            ...
            email: {
              ...
              customMessage: "Thank you for your order! Please find your invoice attached."
            }
          }
  
        const invoiceResponse = await client.graphql(sendOrderInvoice(), invoiceParams);
